<?php
/**
 * Display Block First action
 * Вывод блока Первая акция
 */
...
if ($query_actions->have_posts()) {
    while ($query_actions->have_posts()) {
        $query_actions->the_post();
        ?>
                ...
                <div class="actions__wrap actions-wrap d-grid">
                    <article class="route-item route-item__action position-relative"
                        ...
                        <div class="route-item__wrap position-relative archive-route d-grid">
                            <?php
                            if ($action_digits) { ?>
                                <span class="actions-wrap__digits text-danger" data-aos="fade-left" data-aos-offset="0"
                                    data-aos-delay="100" data-aos-duration="800" data-aos-easing="ease-in" data-aos-once="true"
                            ...
                            if ($actions_one_action_image) { ?>
                                <div class="actions-wrap__image position-relative">
                                    <div class="top-block-right__image top-block-right__image_first-action position-absolute"
                                        ...
                                        data-aos="fade-right" data-aos-offset="0" data-aos-delay="0" data-aos-duration="800"
                                        data-aos-easing="ease-in" data-aos-once="false" data-aos-anchor-placement="top-left"></div>
                                </div>
                            <?php } ?>
                        </div>
                    </article>
