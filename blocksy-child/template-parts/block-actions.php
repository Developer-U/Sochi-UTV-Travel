...
if ($query_actions_block->have_posts()) {
    ...
    <section class="actions gradient-bg">
        <div class="container">
            <?php
            if ($actions_title && !is_singular('actions')) { ?>
            ...
            <?php } elseif (is_singular('actions')) { ?>
                <h2 class="actions__title" data-aos="fade-left" data-aos-offset="400" data-aos-delay="0" data-aos-duration="900"
                    data-aos-easing="linear" data-aos-once="true" data-aos-anchor-placement="bottom-left">
                    Другие наши акции
                </h2>
            <?php }
            ?>
            ...
            <ul class="actions__list actions-list d-flex position-relative">
                ...
                if ($query_actions_block->have_posts()) {
                    ...
                    while ($query_actions_block->have_posts()) {
                        ...
                        <li class="action-item position-relative js-item js-action"
                            data-aos="<?php if ($index == 0 || ($index % 2) == 0) { ?>fade-right<?php } else { ?>fade-left<?php } ?>"
                            data-aos-delay="<?php echo 100 * ($index * 2.5); ?>" data-aos-duration="1000"
                                ...
                                <svg width="154" height="160" viewBox="0 0 154 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_202_868)">
                                        ...
                                        <path
                                            ...
                                            fill="#E35A4D" />
                                        <path d="M90.5057 86.1663L87.0996 86.6902V75.9395L90.5057 75.4086V86.1663Z"
                                            fill="#E35A4D" />
                                        <path
